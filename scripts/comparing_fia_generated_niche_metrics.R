...
opt_clim <- ggplot(data, aes(x=tmp/10, y=tmp_nicheopt_after/10))+
  ...
  theme_bw()
opt_clim
ggsave("./results/kr_fia_results/opt_clim.png", height=5, width=5)
...
mean_clim <- ggplot(data, aes(x=tmp/10, y=tmp_nichemean_after/10))+
  ...
  theme_bw()
mean_clim
ggsave("./results/kr_fia_results/mean_clim.png", height=5, width=5)
...
meansimple_clim <- ggplot(data, aes(x=tmp/10, y=tmp_nichemeansimple_after/10))+
  ...
  theme_bw()
meansimple_clim
ggsave("./results/kr_fia_results/meansimple_clim.png", height=5, width=5)
